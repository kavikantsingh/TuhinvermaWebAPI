    ...
    public class LogHelper
    {
        ...
        public static void SaveIndividualLog(int IndividualId, int? ApplicationId, string LogSource, string LogText, int CreatedBy, int? PageModuleId = null, int? PageModuleTabSubModuleId = null, int? PageTabSectionId = null)
        {
            try
            {
                ...
                IndividualCommentLogDAL objLogBAL = new IndividualCommentLogDAL();
            ...
            {
                LOGING.LogingHelper.SaveExceptionInfo("", ex, "LogHelper - SaveIndividualComment", eSeverity.Error);
            }
        ...
        public static void LogCommunication(int IndividualId, int? ApplicationId, eCommunicationType Type, string Subject, eCommunicationStatus Status, string LogSource, string LogText, string EmailFrom, string EmailTo, int? UserIdFrom, int? UserIdTo, int CreatedBy, int? PageModuleId = null, int? PageModuleTabSubModuleId = null, int? PageTabSectionId = null)
        {
            try
            {
                ...
                IndividualCommunicationLogDAL objLogBAL = new IndividualCommunicationLogDAL();
                ...
                if (objIndCommunicationLog.IndividualCommunicationLogId > 0 && !string.IsNullOrEmpty(EmailTo))
                {
                    ...
                    IndividualCommunicationToLogDAL objToLogBAL = new IndividualCommunicationToLogDAL();
            ...
            {
                LOGING.LogingHelper.SaveExceptionInfo("", ex, "LogHelper - LogCommunication", eSeverity.Error);
            }
